...
const Saved = () => {
  ...
  return (
    <section className="w-[80%] h-full flex flex-col mt-16 mb-24 relative">
      ...
      <div className="  w-full minh-[60vh] py-8    border border-gray-100 rounded">
        {savedData ? (
            ...
            <tbody>
              {savedData.map((data) => {
                return (
                  <tr
                    key={data.id}
                    className=" text-center text-base boder-b  border-gray-100 hover:bg-gray-200 last:border-b-0"
                  >
          ...
          <h1 className="min-h-[60vh] text-lg text-cyan flex items-center justify-center">
            There is not data to diplay please save some coins first ....
          </h1>
        )}
      </div>
      <Outlet />
