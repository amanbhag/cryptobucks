...
const Trending = () => {
  const { getTrendingCoins, trendingCoins, clearSearch } =
  ...
  return (
    <section className="w-[80%] h-full flex flex-col mt-16 mb-24 relative">
      ...
      <div className="  w-full minh-[60vh] py-8  flex flex-wrap justify-evenly  border border-gray-100 rounded">
        {trendingCoins &&
          trendingCoins.map((coin) => (
            <TrendingCoin data={coin.item} key={coin.coin_id} />
          ))}
      </div>
      <Outlet />
    </section>
