...
const Filter = () => {
  let { setCurrency, setSortBy, clearSearch } = useContext(CryptoContext);
      ...
      <div className="flex mr-7 ">
        ...
        <label className="relative flex justify-center items-center ">
          ...
          >
            ...
            <option value="id_desc">id ascending</option>
          </select>
          <img
            src={SelectIcon}
            alt="Select"
        ...
        <button
          className="w-[2rem] ml-4 hover:scale-110 transition-all transition-ease relative right-0"
          onClick={clearSearch}
        >
          <svg
